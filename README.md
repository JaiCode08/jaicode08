...
[![My Skills](https://skillicons.dev/icons?i=arduino,azure,gcp,cs,cpp,py,java,ts,react,sqlite,pytorch,tensorflow,opencv,bash,docker,unity,flask,fastapi)](https://skillicons.dev)
